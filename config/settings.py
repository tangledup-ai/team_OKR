"""
Django settings for OKR Performance System project.
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='OKR'),
        'USER': config('DB_USER', default='OKR'),
        'PASSWORD': config('DB_PASSWORD', default='123OKR'),
        'HOST': config('DB_HOST', default='121.43.104.161'),
